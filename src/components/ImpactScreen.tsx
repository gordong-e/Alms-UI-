    ...
    <div className="px-4 sm:px-6 max-w-lg mx-auto space-y-6 pb-32 pt-2">
      ...
      <div>
        ...
        <p className="text-xs sm:text-sm text-gray-500">
          Tracking local food rescue milestones and environmental savings.
        </p>
      </div>

      {/* Big Hero Impact Card */}
      <div className="bg-[#0a3c1a] text-white rounded-3xl p-6 shadow-lg relative overflow-hidden">
        ...
        <div className="grid grid-cols-2 gap-4 my-2">
          ...
          <div>
            <div className="text-3xl sm:text-4xl font-extrabold text-[#b9f02c] tracking-tight">
              450 <span className="text-xl">kg</span>
            </div>
            <p className="text-xs text-white/70 mt-0.5">Surplus Food Saved</p>
          </div>
        </div>

        <div className="mt-6 pt-4 border-t border-white/15 grid grid-cols-2 gap-3 text-xs text-white/80">
          <div className="flex items-center gap-2">
            <Leaf className="w-4 h-4 text-[#b9f02c]" />
            <span>1,125 kg CO₂e avoided</span>
          </div>
          <div className="flex items-center gap-2">
            <Droplets className="w-4 h-4 text-cyan-300" />
            <span>82,000 L water conserved</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 space-y-4">
        <div className="flex items-center justify-between">
          <h3 className="font-bold text-sm text-[#0a3c1a]">Weekly Rescue Activity</h3>
      ...
      <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 space-y-3">
        <h3 className="font-bold text-sm text-[#0a3c1a]">Verified Community Beneficiaries</h3>
