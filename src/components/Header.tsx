...
export const Header: React.FC<HeaderProps> = ({
  ...
  const handleShare = () => {
    if (navigator.share) {
      navigator.share({
        title: `${profile.organizationName} on Alms`,
        text: `Check out ${profile.organizationName}'s impact on Alms!`,
  ...
  return (
    <header className="sticky top-0 z-40 bg-[#fdfaf5]/90 backdrop-blur-md border-b border-black/[0.04] transition-all">
